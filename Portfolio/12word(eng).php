...
?>	
    <div id="content" class="clearfix">
        <aside>
			...
			<a href="12word(eng).php"><input style="background-color:mediumorchid" type="button" value="Random12(Eng)" name="Random12(Eng)" /></a>
		...
		echo '<table style="margin-left: auto; margin-right: auto;">';	
			echo '<tr>';
				echo '<td>';
					...
					if($words){
						while($i < 12){
							echo '<input onclick= "change1('.$i.')" id="'.$i.'" class="main_btn10" type="button" value="'.$ranEngarray[$i].'">';
								$i++;
						}	
					}
			echo '</td>';
